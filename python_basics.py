...
- Common data types: - String (text) - Integer (whole numbers) - Float (decimals) - Boolean (True/False)
...
The program checks the condition (age >= 18): - If it is true, it runs the first block - If it is false, it runs the second block
